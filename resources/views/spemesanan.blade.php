...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="../css/spemesanan.css">
    </head>
        ...
        <section id="spemesanan">
            ...
            @else
              ...
              @foreach ($deliveries as $delivery)
                <div class="card">
                    <h4>PESANAN ID: {{ $delivery->id }}</h4>
                    <div class="row">

                        <p class="card-text">Tanggal Pesanan: {{ $delivery->created_at }}</p>
                        <p class="card-text">Alamat Pengiriman: {{ $delivery->alamat }}</p>
                        <p class="card-text">Nomor Hp: {{ $delivery->hp }}</p>
                        <p class="card-text">Metode Pembayaran: {{ $delivery->metode }}</p>
    ...
    <script src="../js/spemesanan.js"></script>
</html>
