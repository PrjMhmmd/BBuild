        ...
        <form>
          ...
          <section id="dashboard">
            ...
            @foreach($produks as $produk)
                    <section class="menu">
                        @if($produk->image)
                            <a href="/produk/{{ $produk->slug }}" target="_blank"><img class="img" src="{{ asset('../storage/'. $produk->image) }}"></a>
                        @else
                            <a href="/produk/{{ $produk->slug }}" target="_blank"><img class="img" src="{{ $gambar }}"></a>
                        @endif
