                  ...
                  <div class="slide-content">
                      <div class="card-wrapper swiper-wrapper">
                        ...
                        <div class="card swiper-slide">
                          <figure class="ruang">
                            <a href="/kategori/{{ $kategori->slug }}" target=""><img class="img-1" src="../img/ruangan.jpg"></a>
                            <figcaption class="caption">{{ $kategori->name }}</figcaption>
                          </figure>
                        </div>
                       @endforeach
                      </div>
                ...
                <div class="slide-container swiper">
                  <div class="slide-content">
                      <div class="card-wrapper swiper-wrapper">
                        ...
                        <div class="card swiper-slide">
                          <figure class="ruang">
                            <a href="/ruangan/{{ $ruangan->slug }}" target=""><img class="img-1" src="../img/ruangan.jpg"></a>
                            <figcaption class="caption">{{ $ruangan->name }}</figcaption>
                          </figure>
                        </div>
                       @endforeach
                      </div>
                ...
                <div class="slide-container swiper">
                  <div class="slide-content">
                      <div class="card-wrapper swiper-wrapper">
                        ...
                        <div class="card swiper-slide">
                          <figure class="ruang">
                            <a href="/jenis/{{ $jenis->slug }}" target=""><img class="img-1" src="../img/ruangan.jpg"></a>
                            <figcaption class="caption">{{ $jenis->name }}</figcaption>
                          </figure>
                        </div>
                       @endforeach
